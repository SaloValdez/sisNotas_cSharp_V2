<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="form_Docente.aspx.cs" Inherits="SisMatricula_cSharp_v2.form_Docente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
              <asp:GridView  class="grid" ID="gwDocente" runat="server"
                    AllowPaging="True" AllowSorting="True" OnSelectedIndexChanged="gwDocente_SelectedIndexChanged" OnPageIndexChanging="gwDocente_PageIndexChanging" PageSize="12" >
                        <Columns>
