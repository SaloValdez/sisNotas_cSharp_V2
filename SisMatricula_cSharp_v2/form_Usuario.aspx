<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="form_Usuario.aspx.cs" Inherits="SisMatricula_cSharp_v2.form_Usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
              ...
              <table style="width: 100%;" id="contenedor_cajas">
                  ...
                  <tr>
                      <td id="texto_label"><asp:Label ID="Label2" runat="server" Text="Usuario : "></asp:Label></td>
                      <td> <asp:TextBox ID="txtUsuario" runat="server" onkeyup="javascript:this.value=this.value.toUpperCase();"  ></asp:TextBox></td>
                  </tr>

                   <tr>
                      <td id="texto_label"><asp:Label ID="Label3" runat="server" Text="Contraseña : "></asp:Label></td>
                      <td> <asp:TextBox ID="txtContrasena" runat="server" onkeyup="javascript:this.value=this.value.toUpperCase();"  ></asp:TextBox></td>
                  </tr>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
              <asp:GridView  class="grid" ID="gwUsuario" runat="server"
                    AllowPaging="True" AllowSorting="True" OnSelectedIndexChanged="gwUsuario_SelectedIndexChanged" OnPageIndexChanging="gwUsuario_PageIndexChanging" PageSize="12" >
                        <Columns>
