<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="form_Carrera.aspx.cs" Inherits="SisMatricula_cSharp_v2.form_Carrera" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
              <asp:GridView  class="grid" ID="gwCarrera" runat="server"
                    AllowPaging="True" AllowSorting="True" OnSelectedIndexChanged="gwCarrera_SelectedIndexChanged" OnPageIndexChanging="gwCarrera_PageIndexChanging" PageSize="12" >
                        <Columns>
